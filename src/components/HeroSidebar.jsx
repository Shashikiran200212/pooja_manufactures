...
export function SidebarDemo() {
    ...
    return (
        <div
            className={cn(
                "min-h-screen flex min-w-screen max-w-7xl flex-1 flex-col overflow-hidden rounded-md border border-neutral-200 bg-gray-100 md:flex-row dark:border-neutral-700 dark:bg-neutral-800",
            ...
            <div
                ...
                <div className="flex flex-1 gap-2">
                   <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-black">asddas</div>
                   </div>
                </div>
            </div>
